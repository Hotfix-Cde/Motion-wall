...
- [x] Build the Library experience with persistent favorites and recent plays.
- [x] Build the Theme Studio with four presets, controls, preview, and reduced-motion support.
- [x] Build Orbit Cat, Star Catcher, and Moon Garden mini-games while preserving playback.
